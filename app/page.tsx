      ...
      <section className="relative w-full overflow-x-hidden bg-tertiary">
        ...
        >
          <div className="relative z-10 mx-auto flex w-full flex-col items-center gap-8 p-5 text-center">
            <h2 className="font-primary text-2xl leading-tight text-start text-secondary md:text-5xl">
              “Chaque année, de nouveaux festivals émergent, mais l’accessibilité reste souvent
              négligée.”
            </h2>
            <h3 className="text-2xl z-1000 leading-10  text-start text-secondary  md:text-5xl">
