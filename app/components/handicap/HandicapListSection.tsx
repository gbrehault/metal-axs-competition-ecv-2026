...
const HANDICAPS = [
  {
    ...
    image: '/handicaps/chrome/Auditif.png',
    paragraphs: [
  ...
  },
  {
    ...
    image: '/handicaps/chrome/Visuel.png',
    paragraphs: [
  ...
  },
  {
    ...
    image: '/handicaps/chrome/Mental.png',
    paragraphs: [
  ...
  },
  {
    ...
    image: '/handicaps/chrome/Moteur.png',
    paragraphs: [
  ...
  },
  {
    ...
    image: '/handicaps/chrome/Invisible.png',
    paragraphs: [
  ...
  return (
    ...
    <div className="relative">
      ...
      <div
        ...
        style={{ paddingTop: 'calc(50vh - 140px)' }}
      >
        <nav
        ...
        >
          {HANDICAPS.map((h, i) => (
            <button
              ...
              style={{
                backgroundColor:
                  i === activeIndex ? 'var(--color-primary)' : 'rgba(255,255,255,0.08)',
              }}
            >
              <Image
                src={h.image}
